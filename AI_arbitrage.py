...
async def bot():
    ...
    for symbol in symbols:
        ...
        if (profit > 0): # not taking into account slippage or order book depth
            with open("Profit_orders.txt", 'a') as f:
                f.write(ms, symbol, "profit:", profit, "Buy", min_exchange.id, min_price, "Sell", max_exchange.id, max_price)
            ...
            print(str(ms), symbol, "no arbitrage opportunity: ", symbol, "profit:", profit, "Buy", min_exchange.id, min_price, "Sell", max_exchange.id, max_price)
